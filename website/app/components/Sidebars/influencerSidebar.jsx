    ...
    <div className="h-full flex flex-col justify-between">
      <div className="p-5 overflow-y-auto">
        <div className="flex items-center mb-8">
          ...
          <div className="text-xl font-light ml-4">Add Influencer</div>
        </div>
        <div className="flex">
          <div>
        ...
        {/* Form */}
        <h1 className="text-lg font-normal mt-8">Influencer Information</h1>
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* <div>
              <h1 className="font-normal text-sm mb-1">Role</h1>
              <input
                type="text"
                className="border h-8 rounded-md border-gray-300 w-full pl-3 placeholder:font-light text-sm placeholder:text-sm"
